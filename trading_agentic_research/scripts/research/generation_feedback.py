...
learning, duplicate existing signatures, scoped to a stale candidate, or rejected
by the selector's memory score. This module records that feedback so future
decisions distinguish "generated rows" from "generated useful work".
"""
...
def maybe_mark_candidate_review_exhausted(
    *,
    ...
    result["candidate_review_eligible_remaining"] = selector_diag["selectable_remaining"]
    result["candidate_review_blocked"] = selector_diag["blocked"][:20]
