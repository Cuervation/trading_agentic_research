...
- Variants generated under `reports\dd_guard_grid_HYP_REFINE_AUTO002_TOPN_6_V1_LONGRUN_20260601_230028\generated_configs`.
...
- Reproduce one run by reading `reports\dd_guard_grid_HYP_REFINE_AUTO002_TOPN_6_V1_LONGRUN_20260601_230028\grid_results.csv` -> `run_dir`, then inspect `metrics.json`, `summary.md`, `equity_curve.csv`, and `trades.csv`.
