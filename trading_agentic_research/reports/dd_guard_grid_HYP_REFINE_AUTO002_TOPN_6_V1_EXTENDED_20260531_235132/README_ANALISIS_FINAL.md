...
- Variantes anteriores cargadas: 298.
- Variantes nuevas completed: 129; runs nuevos en `runs/`: 129.
- Completed combinado: 427; Failed: 0; Metric no effect: 0.
...
- Mejor balanceada: `HYP_REFINE_AUTO002_TOPN_6_V1_DDGRID_EXT_R12_C22_E75_CR40_REDD_RECOVERED_DD8_SL20` CAGR 14.04%, DD -32.64%.
- Mejor anterior: `HYP_REFINE_AUTO002_TOPN_6_V1_DDGRID_EXT_R12_C25_E66_CR33_REDD_RECOVERED_DD8_SL20`.
- Mejor nueva: `HYP_REFINE_AUTO002_TOPN_6_V1_DDGRID_EXT_R12_C22_E75_CR40_REDD_RECOVERED_DD8_SL20`.
...
| HYP_REFINE_AUTO002_TOPN_6_V1_DDGRID_EXT_R12_C26_E75_CR25_REDD_RECOVERED_DD8_SL20 | 12.27 | -32.11 | -26.46 | -30.77 | 2831 |
| HYP_REFINE_AUTO002_TOPN_6_V1_DDGRID_EXT_R12_C25_E66_CR33_REDD_RECOVERED_DD8_SL18 | 12.00 | -33.03 | -25.63 | -30.87 | 2832 |
...
## Cómo continuar
```powershell
python .\scripts\run_dd_guard_grid_auto.py --base-strategy HYP_REFINE_AUTO002_TOPN_6_V1 --data-folder "C:\Pythons\ML-Trading\Momentum\trading_agentic_research\data" --output-dir "reports\dd_guard_grid_HYP_REFINE_AUTO002_TOPN_6_V1_EXTENDED_20260531_235132" --stage all --max-screening-runs 250 --max-full-runs 250 --resume --previous-report-dir reports/dd_guard_grid_HYP_REFINE_AUTO002_TOPN_6_V1_20260530_140830 --ensure-runs-output
```

## Conclusión directa para Hernán
- Apareci? una variante nueva mejor que la anterior: `HYP_REFINE_AUTO002_TOPN_6_V1_DDGRID_EXT_R12_C22_E75_CR40_REDD_RECOVERED_DD8_SL20` vs `HYP_REFINE_AUTO002_TOPN_6_V1_DDGRID_EXT_R12_C25_E66_CR33_REDD_RECOVERED_DD8_SL20`.
- Mejor variante: `HYP_REFINE_AUTO002_TOPN_6_V1_DDGRID_EXT_R12_C22_E75_CR40_REDD_RECOVERED_DD8_SL20`.
- Más segura: `HYP_REFINE_AUTO002_TOPN_6_V1_DDGRID_R15_C25_E33_CR0_RECOOLDOWN_180_SPY_SMA200_DD12_SL25`.
- Mejor equilibrio: `HYP_REFINE_AUTO002_TOPN_6_V1_DDGRID_EXT_R12_C22_E75_CR40_REDD_RECOVERED_DD8_SL20`.
- Tradearía: `HYP_REFINE_AUTO002_TOPN_6_V1_DDGRID_EXT_R12_C22_E75_CR40_REDD_RECOVERED_DD8_SL20` si aceptás el modelo daily-close y confirmás robustness fuera de muestra.
