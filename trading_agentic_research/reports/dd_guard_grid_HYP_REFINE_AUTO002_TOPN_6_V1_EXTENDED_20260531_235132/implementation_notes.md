...
- Variants generated under `reports\dd_guard_grid_HYP_REFINE_AUTO002_TOPN_6_V1_EXTENDED_20260531_235132\generated_configs`.
...
- Reproduce one run by reading `reports\dd_guard_grid_HYP_REFINE_AUTO002_TOPN_6_V1_EXTENDED_20260531_235132\grid_results.csv` -> `run_dir`, then inspect `metrics.json`, `summary.md`, `equity_curve.csv`, and `trades.csv`.
